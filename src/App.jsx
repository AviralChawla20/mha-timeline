// Add createPortal to the import from 'react-dom'
...
const season2Data_p1 = [
  ...
  { title: "Bakugo vs. Uraraka", detail: "Season 2 - Episode 22", type: "episode", season: "Season 2", episodeNumber: 9, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1Y7KNm_GwzPY_AUDhGydj5yepbxFkaLDt/view?usp=drive_link"},
  { title: "Shoto Todoroki: Origin", detail: "Season 2 - Episode 23", type: "episode", season: "Season 2", episodeNumber: 10, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1psh9o1k6Y4-nro5lzvAk51W8c_HRlDQH/view?usp=drive_link"},
  { title: "Fight On, Iida", detail: "Season 2 - Episode 24", type: "episode", season: "Season 2", episodeNumber: 11, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1zFwUYu6Fs7KMi0yH0TNPfGDpRVkk13sF/view?usp=drive_link"},
  { title: "Todoroki vs. Bakugo", detail: "Season 2 - Episode 25", type: "episode", season: "Season 2", episodeNumber: 12, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1MmwNK5oiXN5385VvfxaNfMkDHFKXP_F2/view?usp=drive_link"},
  { title: "Encounter", detail: "Season 2 - Episode 26", type: "episode", season: "Season 2", episodeNumber: 13, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1LRfUgk5b3KOdV9LaVjAACc_K29N6a5xU/view?usp=drive_link"},
  { title: "Bizarre! Gran Torino Appears", detail: "Season 2 - Episode 27", type: "episode", season: "Season 2", episodeNumber: 14, theme: "blue",videoUrl:"https://drive.google.com/file/d/12GYjwUqvxDclQLDLOx1j7_Tqbveuk1Go/view?usp=drive_link" },
  { title: "Midoriya and Shigaraki", detail: "Season 2 - Episode 28", type: "episode", season: "Season 2", episodeNumber: 15, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1ugU9jR7byqkd_g-Y92Ie7KlztG1mXRid/view?usp=drive_link"},
  { title: "Hero Killer: Stain vs U.A. Students", detail: "Season 2 - Episode 29", type: "episode", season: "Season 2", episodeNumber: 16, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1NRCE5qDfThO-knB1DUOVqMluwwcdWCW1/view?usp=drive_link"},
  { title: "Climax", detail: "Season 2 - Episode 30", type: "episode", season: "Season 2", episodeNumber: 17, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1Djpy_zV4lExsoivYbx-ud-aYaFDJGRH9/view?usp=drive_link"},
  { title: "The Aftermath of Hero Killer: Stain", detail: "Season 2 - Episode 31", type: "episode", season: "Season 2", episodeNumber: 18, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1hdkOqrooaB4d3kGBCEY2y9Rb7uKwpnQO/view?usp=drive_link"},
  { title: "Everyone’s Internships", detail: "Season 2 - Episode 32", type: "episode", season: "Season 2", episodeNumber: 19, theme: "blue",videoUrl:"https://drive.google.com/file/d/1gi5uTaM2WrqILhyXDaEgI3yNdevmN2_Y/view?usp=drive_link" },
  { title: "Listen Up!! A Tale From the Past", detail: "Season 2 - Episode 33", type: "episode", season: "Season 2", episodeNumber: 20, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1dzeuhoRDlfk6ysT83kQ-ERPrza4W1ICi/view?usp=drive_link"},
];

const season2Data_p2 = [  { title: "Gear up for Final Exams", detail: "Season 2 - Episode 34", type: "episode", season: "Season 2", episodeNumber: 21, theme: "blue",videoUrl:"https://drive.google.com/file/d/1qDT-ailtlSqmKrD37nEmx3HCWueYkMko/view?usp=drive_link" },
  { title: "Yaoyorozu: Rising", detail: "Season 2 - Episode 35", type: "episode", season: "Season 2", episodeNumber: 22, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1B0Zcr4z8dpC3SEVtVXwN4G-XG_i0Iue7/view?usp=drive_link"},
  { title: "Struggle!!", detail: "Season 2 - Episode 36", type: "episode", season: "Season 2", episodeNumber: 23, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1jti0uVawsfaDEsLUg6kjfbTKAONBYSJY/view?usp=drive_link"},
  { title: "Katsuki Bakugo: Origin", detail: "Season 2 - Episode 37", type: "episode", season: "Season 2", episodeNumber: 24, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/1h5dE8A8od25rPxSTwjwGfTYTevXLIJrU/view?usp=drive_link"},
  { title: "Encounter", detail: "Season 2 - Episode 38", type: "episode", season: "Season 2", episodeNumber: 25, theme: "blue" ,videoUrl:"https://drive.google.com/file/d/11A-j0zMorO9HSa3jimxnDdbGfTRn71QN/view?usp=drive_link"},];

const season3Data_p1 = [  { title: "Special Episode: Save the World With Love!!", detail: "Season 3 - Episode 58", type: "episode", season: "Season 3", episodeNumber: 20, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1hf4N3IoPxOaVeZ4oJ76bKeym5sLYGFCG/view?usp=drive_link"},];
  const season3Data_p2 = [
  { title: "Game Start", detail: "Season 3 - Episode 39", type: "episode", season: "Season 3", episodeNumber: 1, theme: "red",videoUrl:"https://drive.google.com/file/d/1MHBfX3d0PrVYaK_NTAltXQJ2VSnlsuG6/view?usp=drive_link" },
  { title: "Wild, Wild Pussycats", detail: "Season 3 - Episode 40", type: "episode", season: "Season 3", episodeNumber: 2, theme: "red" ,videoUrl:"https://drive.google.com/file/d/10iEcj49Wl0Hu0xSSJjlD3curGg9h8JoW/view?usp=drive_link"},
  { title: "Kota", detail: "Season 3 - Episode 41", type: "episode", season: "Season 3", episodeNumber: 3, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1KsoQkcUv4MnMMRYQDnYp3lroxkDnvI8i/view?usp=drive_link"},
  { title: "My Hero", detail: "Season 3 - Episode 42", type: "episode", season: "Season 3", episodeNumber: 4, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1UvAkxaJzygc7BB7AKkMywenSdT6COquy/view?usp=drive_link"},
  { title: "Drive It Home, Iron Fist!", detail: "Season 3 - Episode 43", type: "episode", season: "Season 3", episodeNumber: 5, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1HhRHviulStZr_vZXgVPGlnMEc4ZzKJSz/view?usp=drive_link"},
  { title: "Roaring Upheaval", detail: "Season 3 - Episode 44", type: "episode", season: "Season 3", episodeNumber: 6, theme: "red" ,videoUrl:"https://drive.google.com/file/d/10Fxo13HwHCrnEa7yDDFZnJ9E5q3AuGQI/view?usp=drive_link"},
  { title: "What a Twist!", detail: "Season 3 - Episode 45", type: "episode", season: "Season 3", episodeNumber: 7, theme: "red",videoUrl:"https://drive.google.com/file/d/15kT28i3NHZdLFTZyr1prPFlmhTJ0Zjg6/view?usp=drive_link" },
  { title: "From Iida to Midoriya", detail: "Season 3 - Episode 46", type: "episode", season: "Season 3", episodeNumber: 8, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1RaDo_JKM_dLTQ9rrTqFxnrJTLboerANp/view?usp=drive_link"},
  { title: "All For One", detail: "Season 3 - Episode 47", type: "episode", season: "Season 3", episodeNumber: 9, theme: "red",videoUrl:"https://drive.google.com/file/d/11m6BXDszr1O0ParFXRdJA3rzxUDlUD6H/view?usp=drive_link" },
  { title: "Symbol of Peace", detail: "Season 3 - Episode 48", type: "episode", season: "Season 3", episodeNumber: 10, theme: "red",videoUrl:"https://drive.google.com/file/d/10hj7-AESN0t0-IklzpUbGKvkVnDS-nFe/view?usp=drive_link" },

];

const season3Data_p3 = [  { title: "One For All", detail: "Season 3 - Episode 49", type: "episode", season: "Season 3", episodeNumber: 11, theme: "red" ,videoUrl:"https://drive.google.com/file/d/17GGkaoqboMSHQu3z7K4CziHc82MK3qVN/view?usp=drive_link"},
  { title: "End of the Beginning, Beginning of the End", detail: "Season 3 - Episode 50", type: "episode", season: "Season 3", episodeNumber: 12, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1UxyYtWcft7YrypzpBh8UkViK9C0SY-YC/view?usp=drive_link"},
  { title: "Moving into Dorms", detail: "Season 3 - Episode 51", type: "episode", season: "Season 3", episodeNumber: 13, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1MiwxKU_5D1LLE1pbKTStb5M540RJ9QnS/view?usp=drive_link"},
  { title: "Create Those Ultimate Moves", detail: "Season 3 - Episode 52", type: "episode", season: "Season 3", episodeNumber: 14, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1yl0nTRFgm5zQIA1LyCyxFEZ45x5QG2os/view?usp=drive_link"},
  { title: "The Test Pt. 1", detail: "Season 3 - Episode 53", type: "episode", season: "Season 3", episodeNumber: 15, theme: "red" , videoUrl:"https://drive.google.com/file/d/1J3yFVulCHYXk_rY3ZeYRcD7V9psUuq34/view?usp=drive_link"},
];
const season3Data_p4 = [{ title: "The Test Pt. 2", detail: "Season 3 - Episode 53", type: "episode", season: "Season 3", episodeNumber: 15, theme: "red",videoUrl:"https://drive.google.com/file/d/1CsElv1pkr-huSy1epvimxo_Wn1AJjbaY/view?usp=drive_link" },
  { title: "Shiketsu High Lurking", detail: "Season 3 - Episode 54", type: "episode", season: "Season 3", episodeNumber: 16, theme: "red" ,videoUrl:"https://drive.google.com/file/d/14M4hT8wWxkvzk1ZbB39dC7CnfcqPk_Dm/view?usp=drive_link"},
{ title: "Class 1-A", detail: "Season 3 - Episode 55", type: "episode", season: "Season 3", episodeNumber: 17, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1X6qhOtt5gVey3a0iAzAjCnj1Hvd4olII/view?usp=drive_link"},
{ title: "RUSH!", detail: "Season 3 - Episode 56", type: "episode", season: "Season 3", episodeNumber: 18, theme: "red",videoUrl:"https://drive.google.com/file/d/1y1UXXpu238c-Agx4ivfWojLgBAXTk8RQ/view?usp=drive_link" },
{ title: "Rescue Exercises", detail: "Season 3 - Episode 57", type: "episode", season: "Season 3", episodeNumber: 19, theme: "red" ,videoUrl:"https://drive.google.com/file/d/10Qyix0rGGrFXVK5HQ16ePC4UeEENmy9h/view?usp=drive_link"},

{ title: "What’s the Big Idea?", detail: "Season 3 - Episode 59", type: "episode", season: "Season 3", episodeNumber: 21, theme: "red",videoUrl:"https://drive.google.com/file/d/1cCZTwZNY8u_8gRVji1m9nyMa7R2QcsG7/view?usp=drive_link" },
{ title: "A Talk About Your Quirk", detail: "Season 3 - Episode 60", type: "episode", season: "Season 3", episodeNumber: 22, theme: "red",videoUrl:"https://drive.google.com/file/d/13ajL421C9ak0Rp41RK_fqn9huCfBItXq/view?usp=drive_link" },
{ title: "Deku vs. Kacchan, Part 2", detail: "Season 3 - Episode 61", type: "episode", season: "Season 3", episodeNumber: 23, theme: "red" ,videoUrl:"https://drive.google.com/file/d/1xb6Hv7o2anRoBTMDMHfxlWQNlyu1ZGnw/view?usp=drive_link"},
{ title: "A Season for Encounters", detail: "Season 3 - Episode 62", type: "episode", season: "Season 3", episodeNumber: 24, theme: "red",videoUrl:"https://drive.google.com/file/d/1Ha_NRWuJEjiWCtdVbp5YA-3zYrgNVVzH/view?usp=drive_link" },
{ title: "Unrivaled", detail: "Season 3 - Episode 63", type: "episode", season: "Season 3", episodeNumber: 25, theme: "red" ,videoUrl:"https://drive.google.com/file/d/16StkGUfszoL9yolUPbs3Tv6VYe4TFx5E/view?usp=drive_link"},];
